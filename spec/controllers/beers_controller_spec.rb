...
RSpec.describe BeersController, type: :controller do
  ...
  describe "GET #index" do
    context 'when logged in' do
      ...
      it 'renders the beers index page' do
        get :index
  ...
  describe "GET #new" do
    context 'when logged in' do
      ...
      it 'renders the new beer page' do
        get :new
        expect(response).to have_http_status(:success)
    ...
    context 'when logged in' do
      ...
      context 'with invalid params' do
        it 'validates the presence of name and brewery_id' do
          post :create, params: { beer: { name: 'this is an invalid beer' } }
          expect(response).to render_template('new')
      ...
      context 'with valid params' do
        it 'redirects to the beer show page' do
          post :create, params: { beer: { name: 'Teehee Lager', brewery_id: bumblewood_brews.id } }
